...
// intSeq - This funcution intSeq returns another function, which we define
// anonymously in the body of intSeq. The returned function
// closes over the variable i to from a closure.
